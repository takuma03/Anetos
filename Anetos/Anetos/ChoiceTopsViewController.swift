...
class ChoiceTopsViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource,UIImagePickerControllerDelegate,UINavigationControllerDelegate ,URLSessionTaskDelegate{
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        print("アップロードを開始しました。")
        // アップロード先を指定する
        var request = URLRequest(url:URL(string:"http://52.196.123.118:3000/api/v1/clothes/")!)
